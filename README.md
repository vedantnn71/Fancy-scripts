This are my scripts that make often used programs fancy with gradients. Installation is quite simple, just copy all the files of directory scripts to .local/bin or to /usr/bin (not recommended).
